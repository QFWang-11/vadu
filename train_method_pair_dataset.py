...
from datasets.build_mix_view import build_test_loader    #加载混合数据集
...
from datasets.build_G2APS_pair import build_train_loader
from defaults import get_default_cfg
from engine import train_one_epoch_method_pair_dataset, evaluate_performance_Re_ID
from models.seqnet_model_decomp_pair_dataset_input import SeqNet
...
def main(args):
    ...
    for epoch in range(start_epoch, cfg.SOLVER.MAX_EPOCHS):
        ...
        train_one_epoch_method_pair_dataset(cfg, model, optimizer, train_loader, device, epoch, tfboard)
        lr_scheduler.step()
