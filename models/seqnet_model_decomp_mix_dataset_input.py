...
class SeqNet(nn.Module):
    ...
    def _rename_state_dict(self, state_dict):
        ...
        name_mapping = {
            ...
            'backbone_aerial.layer2.3.conv1.weight': 'backbone.layer2.3.conv1.weight', 
            'backbone_aerial.layer2.3.bn1.weight': 'backbone.layer2.3.bn1.weight', 
            'backbone_aerial.layer2.3.bn1.bias': 'backbone.layer2.3.bn1.bias', 
            'backbone_aerial.layer2.3.bn1.running_mean': 'backbone.layer2.3.bn1.running_mean', 
            'backbone_aerial.layer2.3.bn1.running_var': 'backbone.layer2.3.bn1.running_var', 
            'backbone_aerial.layer2.3.bn1.num_batches_tracked': 'backbone.layer2.3.bn1.num_batches_tracked', 
            'backbone_aerial.layer2.3.conv2.weight': 'backbone.layer2.3.conv2.weight', 
            'backbone_aerial.layer2.3.bn2.weight': 'backbone.layer2.3.bn2.weight', 
            'backbone_aerial.layer2.3.bn2.bias': 'backbone.layer2.3.bn2.bias', 
            'backbone_aerial.layer2.3.bn2.running_mean': 'backbone.layer2.3.bn2.running_mean', 
            'backbone_aerial.layer2.3.bn2.running_var': 'backbone.layer2.3.bn2.running_var', 
            'backbone_aerial.layer2.3.bn2.num_batches_tracked': 'backbone.layer2.3.bn2.num_batches_tracked', 

            'backbone_ground.layer2.3.conv1.weight': 'backbone.layer2.3.conv1.weight', 
            'backbone_ground.layer2.3.bn1.weight': 'backbone.layer2.3.bn1.weight', 
            'backbone_ground.layer2.3.bn1.bias': 'backbone.layer2.3.bn1.bias', 
            'backbone_ground.layer2.3.bn1.running_mean': 'backbone.layer2.3.bn1.running_mean', 
            'backbone_ground.layer2.3.bn1.running_var': 'backbone.layer2.3.bn1.running_var', 
            'backbone_ground.layer2.3.bn1.num_batches_tracked': 'backbone.layer2.3.bn1.num_batches_tracked', 
            'backbone_ground.layer2.3.conv2.weight': 'backbone.layer2.3.conv2.weight', 
            'backbone_ground.layer2.3.bn2.weight': 'backbone.layer2.3.bn2.weight', 
            'backbone_ground.layer2.3.bn2.bias': 'backbone.layer2.3.bn2.bias', 
            'backbone_ground.layer2.3.bn2.running_mean': 'backbone.layer2.3.bn2.running_mean', 
            'backbone_ground.layer2.3.bn2.running_var': 'backbone.layer2.3.bn2.running_var', 
            'backbone_ground.layer2.3.bn2.num_batches_tracked': 'backbone.layer2.3.bn2.num_batches_tracked',

            'backbone_aerial.conv1.weight': 'backbone.conv1.weight', 
            'backbone_aerial.bn1.weight': 'backbone.bn1.weight',
            'backbone_aerial.bn1.bias': 'backbone.bn1.bias', 
            'backbone_aerial.bn1.running_mean': 'backbone.bn1.running_mean', 
            'backbone_aerial.bn1.running_var': 'backbone.bn1.running_var', 
            'backbone_aerial.bn1.num_batches_tracked': 'backbone.bn1.num_batches_tracked', 
            'backbone_aerial.layer1.0.conv1.weight': 'backbone.layer1.0.conv1.weight', 
            'backbone_aerial.layer1.0.bn1.weight': 'backbone.layer1.0.bn1.weight', 
            'backbone_aerial.layer1.0.bn1.bias': 'backbone.layer1.0.bn1.bias', 
            'backbone_aerial.layer1.0.bn1.running_mean': 'backbone.layer1.0.bn1.running_mean', 
            'backbone_aerial.layer1.0.bn1.running_var': 'backbone.layer1.0.bn1.running_var', 
            'backbone_aerial.layer1.0.bn1.num_batches_tracked': 'backbone.layer1.0.bn1.num_batches_tracked', 
            'backbone_aerial.layer1.0.conv2.weight': 'backbone.layer1.0.conv2.weight', 
            'backbone_aerial.layer1.0.bn2.weight': 'backbone.layer1.0.bn2.weight', 
            'backbone_aerial.layer1.0.bn2.bias': 'backbone.layer1.0.bn2.bias', 
            'backbone_aerial.layer1.0.bn2.running_mean': 'backbone.layer1.0.bn2.running_mean', 
            'backbone_aerial.layer1.0.bn2.running_var': 'backbone.layer1.0.bn2.running_var', 
            'backbone_aerial.layer1.0.bn2.num_batches_tracked': 'backbone.layer1.0.bn2.num_batches_tracked', 
            'backbone_aerial.layer1.1.conv1.weight': 'backbone.layer1.1.conv1.weight', 
            'backbone_aerial.layer1.1.bn1.weight': 'backbone.layer1.1.bn1.weight', 
            'backbone_aerial.layer1.1.bn1.bias': 'backbone.layer1.1.bn1.bias', 
            'backbone_aerial.layer1.1.bn1.running_mean': 'backbone.layer1.1.bn1.running_mean', 
            'backbone_aerial.layer1.1.bn1.running_var': 'backbone.layer1.1.bn1.running_var', 
            'backbone_aerial.layer1.1.bn1.num_batches_tracked': 'backbone.layer1.1.bn1.num_batches_tracked', 
            'backbone_aerial.layer1.1.conv2.weight': 'backbone.layer1.1.conv2.weight', 
            'backbone_aerial.layer1.1.bn2.weight': 'backbone.layer1.1.bn2.weight', 
            'backbone_aerial.layer1.1.bn2.bias': 'backbone.layer1.1.bn2.bias', 
            'backbone_aerial.layer1.1.bn2.running_mean': 'backbone.layer1.1.bn2.running_mean', 
            'backbone_aerial.layer1.1.bn2.running_var': 'backbone.layer1.1.bn2.running_var', 
            'backbone_aerial.layer1.1.bn2.num_batches_tracked': 'backbone.layer1.1.bn2.num_batches_tracked', 
            'backbone_aerial.layer1.2.conv1.weight': 'backbone.layer1.2.conv1.weight', 
            'backbone_aerial.layer1.2.bn1.weight': 'backbone.layer1.2.bn1.weight', 
            'backbone_aerial.layer1.2.bn1.bias': 'backbone.layer1.2.bn1.bias', 
            'backbone_aerial.layer1.2.bn1.running_mean': 'backbone.layer1.2.bn1.running_mean', 
            'backbone_aerial.layer1.2.bn1.running_var': 'backbone.layer1.2.bn1.running_var', 
            'backbone_aerial.layer1.2.bn1.num_batches_tracked': 'backbone.layer1.2.bn1.num_batches_tracked', 
            'backbone_aerial.layer1.2.conv2.weight': 'backbone.layer1.2.conv2.weight', 
            'backbone_aerial.layer1.2.bn2.weight': 'backbone.layer1.2.bn2.weight', 
            'backbone_aerial.layer1.2.bn2.bias': 'backbone.layer1.2.bn2.bias', 
            'backbone_aerial.layer1.2.bn2.running_mean': 'backbone.layer1.2.bn2.running_mean', 
            'backbone_aerial.layer1.2.bn2.running_var': 'backbone.layer1.2.bn2.running_var', 
            'backbone_aerial.layer1.2.bn2.num_batches_tracked': 'backbone.layer1.2.bn2.num_batches_tracked', 
            'backbone_aerial.layer2.0.conv1.weight': 'backbone.layer2.0.conv1.weight', 
            'backbone_aerial.layer2.0.bn1.weight': 'backbone.layer2.0.bn1.weight', 
            'backbone_aerial.layer2.0.bn1.bias': 'backbone.layer2.0.bn1.bias', 
            'backbone_aerial.layer2.0.bn1.running_mean': 'backbone.layer2.0.bn1.running_mean', 
            'backbone_aerial.layer2.0.bn1.running_var': 'backbone.layer2.0.bn1.running_var', 
            'backbone_aerial.layer2.0.bn1.num_batches_tracked': 'backbone.layer2.0.bn1.num_batches_tracked', 
            'backbone_aerial.layer2.0.conv2.weight': 'backbone.layer2.0.conv2.weight', 
            'backbone_aerial.layer2.0.bn2.weight': 'backbone.layer2.0.bn2.weight', 
            'backbone_aerial.layer2.0.bn2.bias': 'backbone.layer2.0.bn2.bias', 
            'backbone_aerial.layer2.0.bn2.running_mean': 'backbone.layer2.0.bn2.running_mean', 
            'backbone_aerial.layer2.0.bn2.running_var': 'backbone.layer2.0.bn2.running_var', 
            'backbone_aerial.layer2.0.bn2.num_batches_tracked': 'backbone.layer2.0.bn2.num_batches_tracked', 
            'backbone_aerial.layer2.0.downsample.0.weight': 'backbone.layer2.0.downsample.0.weight', 
            'backbone_aerial.layer2.0.downsample.1.weight': 'backbone.layer2.0.downsample.1.weight', 
            'backbone_aerial.layer2.0.downsample.1.bias': 'backbone.layer2.0.downsample.1.bias', 
            'backbone_aerial.layer2.0.downsample.1.running_mean': 'backbone.layer2.0.downsample.1.running_mean', 
            'backbone_aerial.layer2.0.downsample.1.running_var': 'backbone.layer2.0.downsample.1.running_var', 
            'backbone_aerial.layer2.0.downsample.1.num_batches_tracked': 'backbone.layer2.0.downsample.1.num_batches_tracked', 
            'backbone_aerial.layer2.1.conv1.weight': 'backbone.layer2.1.conv1.weight', 
            'backbone_aerial.layer2.1.bn1.weight': 'backbone.layer2.1.bn1.weight', 
            'backbone_aerial.layer2.1.bn1.bias': 'backbone.layer2.1.bn1.bias', 
            'backbone_aerial.layer2.1.bn1.running_mean': 'backbone.layer2.1.bn1.running_mean', 
            'backbone_aerial.layer2.1.bn1.running_var': 'backbone.layer2.1.bn1.running_var', 
            'backbone_aerial.layer2.1.bn1.num_batches_tracked': 'backbone.layer2.1.bn1.num_batches_tracked', 
            'backbone_aerial.layer2.1.conv2.weight': 'backbone.layer2.1.conv2.weight', 
            'backbone_aerial.layer2.1.bn2.weight': 'backbone.layer2.1.bn2.weight', 
            'backbone_aerial.layer2.1.bn2.bias': 'backbone.layer2.1.bn2.bias', 
            'backbone_aerial.layer2.1.bn2.running_mean': 'backbone.layer2.1.bn2.running_mean', 
            'backbone_aerial.layer2.1.bn2.running_var': 'backbone.layer2.1.bn2.running_var', 
            'backbone_aerial.layer2.1.bn2.num_batches_tracked': 'backbone.layer2.1.bn2.num_batches_tracked', 
            'backbone_aerial.layer2.2.conv1.weight': 'backbone.layer2.2.conv1.weight', 
            'backbone_aerial.layer2.2.bn1.weight': 'backbone.layer2.2.bn1.weight', 
            'backbone_aerial.layer2.2.bn1.bias': 'backbone.layer2.2.bn1.bias', 
            'backbone_aerial.layer2.2.bn1.running_mean': 'backbone.layer2.2.bn1.running_mean', 
            'backbone_aerial.layer2.2.bn1.running_var': 'backbone.layer2.2.bn1.running_var', 
            'backbone_aerial.layer2.2.bn1.num_batches_tracked': 'backbone.layer2.2.bn1.num_batches_tracked', 
            'backbone_aerial.layer2.2.conv2.weight': 'backbone.layer2.2.conv2.weight', 
            'backbone_aerial.layer2.2.bn2.weight': 'backbone.layer2.2.bn2.weight', 
            'backbone_aerial.layer2.2.bn2.bias': 'backbone.layer2.2.bn2.bias', 
            'backbone_aerial.layer2.2.bn2.running_mean': 'backbone.layer2.2.bn2.running_mean', 
            'backbone_aerial.layer2.2.bn2.running_var': 'backbone.layer2.2.bn2.running_var', 
            'backbone_aerial.layer2.2.bn2.num_batches_tracked': 'backbone.layer2.2.bn2.num_batches_tracked', 
            'backbone_aerial.layer3.0.conv1.weight': 'backbone.layer3.0.conv1.weight', 
            'backbone_aerial.layer3.0.bn1.weight': 'backbone.layer3.0.bn1.weight', 
            'backbone_aerial.layer3.0.bn1.bias': 'backbone.layer3.0.bn1.bias', 
            'backbone_aerial.layer3.0.bn1.running_mean': 'backbone.layer3.0.bn1.running_mean', 
            'backbone_aerial.layer3.0.bn1.running_var': 'backbone.layer3.0.bn1.running_var', 
            'backbone_aerial.layer3.0.bn1.num_batches_tracked': 'backbone.layer3.0.bn1.num_batches_tracked', 
            'backbone_aerial.layer3.0.conv2.weight': 'backbone.layer3.0.conv2.weight', 
            'backbone_aerial.layer3.0.bn2.weight': 'backbone.layer3.0.bn2.weight', 
            'backbone_aerial.layer3.0.bn2.bias': 'backbone.layer3.0.bn2.bias', 
            'backbone_aerial.layer3.0.bn2.running_mean': 'backbone.layer3.0.bn2.running_mean', 
            'backbone_aerial.layer3.0.bn2.running_var': 'backbone.layer3.0.bn2.running_var', 
            'backbone_aerial.layer3.0.bn2.num_batches_tracked': 'backbone.layer3.0.bn2.num_batches_tracked', 
            'backbone_aerial.layer3.0.downsample.0.weight': 'backbone.layer3.0.downsample.0.weight', 
            'backbone_aerial.layer3.0.downsample.1.weight': 'backbone.layer3.0.downsample.1.weight', 
            'backbone_aerial.layer3.0.downsample.1.bias': 'backbone.layer3.0.downsample.1.bias', 
            'backbone_aerial.layer3.0.downsample.1.running_mean': 'backbone.layer3.0.downsample.1.running_mean', 
            'backbone_aerial.layer3.0.downsample.1.running_var': 'backbone.layer3.0.downsample.1.running_var', 
            'backbone_aerial.layer3.0.downsample.1.num_batches_tracked': 'backbone.layer3.0.downsample.1.num_batches_tracked', 
            'backbone_aerial.layer3.1.conv1.weight': 'backbone.layer3.1.conv1.weight', 
            'backbone_aerial.layer3.1.bn1.weight': 'backbone.layer3.1.bn1.weight', 
            'backbone_aerial.layer3.1.bn1.bias': 'backbone.layer3.1.bn1.bias', 
            'backbone_aerial.layer3.1.bn1.running_mean': 'backbone.layer3.1.bn1.running_mean', 
            'backbone_aerial.layer3.1.bn1.running_var': 'backbone.layer3.1.bn1.running_var', 
            'backbone_aerial.layer3.1.bn1.num_batches_tracked': 'backbone.layer3.1.bn1.num_batches_tracked', 
            'backbone_aerial.layer3.1.conv2.weight': 'backbone.layer3.1.conv2.weight', 
            'backbone_aerial.layer3.1.bn2.weight': 'backbone.layer3.1.bn2.weight', 
            'backbone_aerial.layer3.1.bn2.bias': 'backbone.layer3.1.bn2.bias', 
            'backbone_aerial.layer3.1.bn2.running_mean': 'backbone.layer3.1.bn2.running_mean', 
            'backbone_aerial.layer3.1.bn2.running_var': 'backbone.layer3.1.bn2.running_var', 
            'backbone_aerial.layer3.1.bn2.num_batches_tracked': 'backbone.layer3.1.bn2.num_batches_tracked', 
            'backbone_aerial.layer3.2.conv1.weight': 'backbone.layer3.2.conv1.weight', 
            'backbone_aerial.layer3.2.bn1.weight': 'backbone.layer3.2.bn1.weight', 
            'backbone_aerial.layer3.2.bn1.bias': 'backbone.layer3.2.bn1.bias', 
            'backbone_aerial.layer3.2.bn1.running_mean': 'backbone.layer3.2.bn1.running_mean', 
            'backbone_aerial.layer3.2.bn1.running_var': 'backbone.layer3.2.bn1.running_var', 
            'backbone_aerial.layer3.2.bn1.num_batches_tracked': 'backbone.layer3.2.bn1.num_batches_tracked', 
            'backbone_aerial.layer3.2.conv2.weight': 'backbone.layer3.2.conv2.weight', 
            'backbone_aerial.layer3.2.bn2.weight': 'backbone.layer3.2.bn2.weight', 
            'backbone_aerial.layer3.2.bn2.bias': 'backbone.layer3.2.bn2.bias', 
            'backbone_aerial.layer3.2.bn2.running_mean': 'backbone.layer3.2.bn2.running_mean', 
            'backbone_aerial.layer3.2.bn2.running_var': 'backbone.layer3.2.bn2.running_var', 
            'backbone_aerial.layer3.2.bn2.num_batches_tracked': 'backbone.layer3.2.bn2.num_batches_tracked',  
            'backbone_aerial.layer3.3.conv1.weight': 'backbone.layer3.3.conv1.weight',
            'backbone_aerial.layer3.3.bn1.weight': 'backbone.layer3.3.bn1.weight',
            'backbone_aerial.layer3.3.bn1.bias': 'backbone.layer3.3.bn1.bias',
            'backbone_aerial.layer3.3.bn1.running_mean': 'backbone.layer3.3.bn1.running_mean',
            'backbone_aerial.layer3.3.bn1.running_var': 'backbone.layer3.3.bn1.running_var',
            'backbone_aerial.layer3.3.bn1.num_batches_tracked': 'backbone.layer3.3.bn1.num_batches_tracked',
            'backbone_aerial.layer3.3.conv2.weight': 'backbone.layer3.3.conv2.weight',
            'backbone_aerial.layer3.3.bn2.weight': 'backbone.layer3.3.bn2.weight',
            'backbone_aerial.layer3.3.bn2.bias': 'backbone.layer3.3.bn2.bias',
            'backbone_aerial.layer3.3.bn2.running_mean': 'backbone.layer3.3.bn2.running_mean',
            'backbone_aerial.layer3.3.bn2.running_var': 'backbone.layer3.3.bn2.running_var',
            'backbone_aerial.layer3.3.bn2.num_batches_tracked': 'backbone.layer3.3.bn2.num_batches_tracked',
            'backbone_aerial.layer3.4.conv1.weight': 'backbone.layer3.4.conv1.weight',
            'backbone_aerial.layer3.4.bn1.weight': 'backbone.layer3.4.bn1.weight',
            'backbone_aerial.layer3.4.bn1.bias': 'backbone.layer3.4.bn1.bias',
            'backbone_aerial.layer3.4.bn1.running_mean': 'backbone.layer3.4.bn1.running_mean',
            'backbone_aerial.layer3.4.bn1.running_var': 'backbone.layer3.4.bn1.running_var',
            'backbone_aerial.layer3.4.bn1.num_batches_tracked': 'backbone.layer3.4.bn1.num_batches_tracked',
            'backbone_aerial.layer3.4.conv2.weight': 'backbone.layer3.4.conv2.weight',
            'backbone_aerial.layer3.4.bn2.weight': 'backbone.layer3.4.bn2.weight',
            'backbone_aerial.layer3.4.bn2.bias': 'backbone.layer3.4.bn2.bias',
            'backbone_aerial.layer3.4.bn2.running_mean': 'backbone.layer3.4.bn2.running_mean',
            'backbone_aerial.layer3.4.bn2.running_var': 'backbone.layer3.4.bn2.running_var',
            'backbone_aerial.layer3.4.bn2.num_batches_tracked': 'backbone.layer3.4.bn2.num_batches_tracked',
            'backbone_aerial.layer3.5.conv1.weight': 'backbone.layer3.5.conv1.weight',
            'backbone_aerial.layer3.5.bn1.weight': 'backbone.layer3.5.bn1.weight',
            'backbone_aerial.layer3.5.bn1.bias': 'backbone.layer3.5.bn1.bias',
            'backbone_aerial.layer3.5.bn1.running_mean': 'backbone.layer3.5.bn1.running_mean',
            'backbone_aerial.layer3.5.bn1.running_var': 'backbone.layer3.5.bn1.running_var',
            'backbone_aerial.layer3.5.bn1.num_batches_tracked': 'backbone.layer3.5.bn1.num_batches_tracked',
            'backbone_aerial.layer3.5.conv2.weight': 'backbone.layer3.5.conv2.weight',
            'backbone_aerial.layer3.5.bn2.weight': 'backbone.layer3.5.bn2.weight',
            'backbone_aerial.layer3.5.bn2.bias': 'backbone.layer3.5.bn2.bias',
            'backbone_aerial.layer3.5.bn2.running_mean': 'backbone.layer3.5.bn2.running_mean',
            'backbone_aerial.layer3.5.bn2.running_var': 'backbone.layer3.5.bn2.running_var',
            'backbone_aerial.layer3.5.bn2.num_batches_tracked': 'backbone.layer3.5.bn2.num_batches_tracked',

            'backbone_ground.conv1.weight': 'backbone.conv1.weight', 
            'backbone_ground.bn1.weight': 'backbone.bn1.weight',
            'backbone_ground.bn1.bias': 'backbone.bn1.bias', 
            'backbone_ground.bn1.running_mean': 'backbone.bn1.running_mean', 
            'backbone_ground.bn1.running_var': 'backbone.bn1.running_var', 
            'backbone_ground.bn1.num_batches_tracked': 'backbone.bn1.num_batches_tracked', 
            'backbone_ground.layer1.0.conv1.weight': 'backbone.layer1.0.conv1.weight', 
            'backbone_ground.layer1.0.bn1.weight': 'backbone.layer1.0.bn1.weight', 
            'backbone_ground.layer1.0.bn1.bias': 'backbone.layer1.0.bn1.bias', 
            'backbone_ground.layer1.0.bn1.running_mean': 'backbone.layer1.0.bn1.running_mean', 
            'backbone_ground.layer1.0.bn1.running_var': 'backbone.layer1.0.bn1.running_var', 
            'backbone_ground.layer1.0.bn1.num_batches_tracked': 'backbone.layer1.0.bn1.num_batches_tracked', 
            'backbone_ground.layer1.0.conv2.weight': 'backbone.layer1.0.conv2.weight', 
            'backbone_ground.layer1.0.bn2.weight': 'backbone.layer1.0.bn2.weight', 
            'backbone_ground.layer1.0.bn2.bias': 'backbone.layer1.0.bn2.bias', 
            'backbone_ground.layer1.0.bn2.running_mean': 'backbone.layer1.0.bn2.running_mean', 
            'backbone_ground.layer1.0.bn2.running_var': 'backbone.layer1.0.bn2.running_var', 
            'backbone_ground.layer1.0.bn2.num_batches_tracked': 'backbone.layer1.0.bn2.num_batches_tracked', 
            'backbone_ground.layer1.1.conv1.weight': 'backbone.layer1.1.conv1.weight', 
            'backbone_ground.layer1.1.bn1.weight': 'backbone.layer1.1.bn1.weight', 
            'backbone_ground.layer1.1.bn1.bias': 'backbone.layer1.1.bn1.bias', 
            'backbone_ground.layer1.1.bn1.running_mean': 'backbone.layer1.1.bn1.running_mean', 
            'backbone_ground.layer1.1.bn1.running_var': 'backbone.layer1.1.bn1.running_var', 
            'backbone_ground.layer1.1.bn1.num_batches_tracked': 'backbone.layer1.1.bn1.num_batches_tracked', 
            'backbone_ground.layer1.1.conv2.weight': 'backbone.layer1.1.conv2.weight', 
            'backbone_ground.layer1.1.bn2.weight': 'backbone.layer1.1.bn2.weight', 
            'backbone_ground.layer1.1.bn2.bias': 'backbone.layer1.1.bn2.bias', 
            'backbone_ground.layer1.1.bn2.running_mean': 'backbone.layer1.1.bn2.running_mean', 
            'backbone_ground.layer1.1.bn2.running_var': 'backbone.layer1.1.bn2.running_var', 
            'backbone_ground.layer1.1.bn2.num_batches_tracked': 'backbone.layer1.1.bn2.num_batches_tracked', 
            'backbone_ground.layer1.2.conv1.weight': 'backbone.layer1.2.conv1.weight', 
            'backbone_ground.layer1.2.bn1.weight': 'backbone.layer1.2.bn1.weight', 
            'backbone_ground.layer1.2.bn1.bias': 'backbone.layer1.2.bn1.bias', 
            'backbone_ground.layer1.2.bn1.running_mean': 'backbone.layer1.2.bn1.running_mean', 
            'backbone_ground.layer1.2.bn1.running_var': 'backbone.layer1.2.bn1.running_var', 
            'backbone_ground.layer1.2.bn1.num_batches_tracked': 'backbone.layer1.2.bn1.num_batches_tracked', 
            'backbone_ground.layer1.2.conv2.weight': 'backbone.layer1.2.conv2.weight', 
            'backbone_ground.layer1.2.bn2.weight': 'backbone.layer1.2.bn2.weight', 
            'backbone_ground.layer1.2.bn2.bias': 'backbone.layer1.2.bn2.bias', 
            'backbone_ground.layer1.2.bn2.running_mean': 'backbone.layer1.2.bn2.running_mean', 
            'backbone_ground.layer1.2.bn2.running_var': 'backbone.layer1.2.bn2.running_var', 
            'backbone_ground.layer1.2.bn2.num_batches_tracked': 'backbone.layer1.2.bn2.num_batches_tracked', 
            'backbone_ground.layer2.0.conv1.weight': 'backbone.layer2.0.conv1.weight', 
            'backbone_ground.layer2.0.bn1.weight': 'backbone.layer2.0.bn1.weight', 
            'backbone_ground.layer2.0.bn1.bias': 'backbone.layer2.0.bn1.bias', 
            'backbone_ground.layer2.0.bn1.running_mean': 'backbone.layer2.0.bn1.running_mean', 
            'backbone_ground.layer2.0.bn1.running_var': 'backbone.layer2.0.bn1.running_var', 
            'backbone_ground.layer2.0.bn1.num_batches_tracked': 'backbone.layer2.0.bn1.num_batches_tracked', 
            'backbone_ground.layer2.0.conv2.weight': 'backbone.layer2.0.conv2.weight', 
            'backbone_ground.layer2.0.bn2.weight': 'backbone.layer2.0.bn2.weight', 
            'backbone_ground.layer2.0.bn2.bias': 'backbone.layer2.0.bn2.bias', 
            'backbone_ground.layer2.0.bn2.running_mean': 'backbone.layer2.0.bn2.running_mean', 
            'backbone_ground.layer2.0.bn2.running_var': 'backbone.layer2.0.bn2.running_var', 
            'backbone_ground.layer2.0.bn2.num_batches_tracked': 'backbone.layer2.0.bn2.num_batches_tracked', 
            'backbone_ground.layer2.0.downsample.0.weight': 'backbone.layer2.0.downsample.0.weight', 
            'backbone_ground.layer2.0.downsample.1.weight': 'backbone.layer2.0.downsample.1.weight', 
            'backbone_ground.layer2.0.downsample.1.bias': 'backbone.layer2.0.downsample.1.bias', 
            'backbone_ground.layer2.0.downsample.1.running_mean': 'backbone.layer2.0.downsample.1.running_mean', 
            'backbone_ground.layer2.0.downsample.1.running_var': 'backbone.layer2.0.downsample.1.running_var', 
            'backbone_ground.layer2.0.downsample.1.num_batches_tracked': 'backbone.layer2.0.downsample.1.num_batches_tracked', 
            'backbone_ground.layer2.1.conv1.weight': 'backbone.layer2.1.conv1.weight', 
            'backbone_ground.layer2.1.bn1.weight': 'backbone.layer2.1.bn1.weight', 
            'backbone_ground.layer2.1.bn1.bias': 'backbone.layer2.1.bn1.bias', 
            'backbone_ground.layer2.1.bn1.running_mean': 'backbone.layer2.1.bn1.running_mean', 
            'backbone_ground.layer2.1.bn1.running_var': 'backbone.layer2.1.bn1.running_var', 
            'backbone_ground.layer2.1.bn1.num_batches_tracked': 'backbone.layer2.1.bn1.num_batches_tracked', 
            'backbone_ground.layer2.1.conv2.weight': 'backbone.layer2.1.conv2.weight', 
            'backbone_ground.layer2.1.bn2.weight': 'backbone.layer2.1.bn2.weight', 
            'backbone_ground.layer2.1.bn2.bias': 'backbone.layer2.1.bn2.bias', 
            'backbone_ground.layer2.1.bn2.running_mean': 'backbone.layer2.1.bn2.running_mean', 
            'backbone_ground.layer2.1.bn2.running_var': 'backbone.layer2.1.bn2.running_var', 
            'backbone_ground.layer2.1.bn2.num_batches_tracked': 'backbone.layer2.1.bn2.num_batches_tracked', 
            'backbone_ground.layer2.2.conv1.weight': 'backbone.layer2.2.conv1.weight', 
            'backbone_ground.layer2.2.bn1.weight': 'backbone.layer2.2.bn1.weight', 
            'backbone_ground.layer2.2.bn1.bias': 'backbone.layer2.2.bn1.bias', 
            'backbone_ground.layer2.2.bn1.running_mean': 'backbone.layer2.2.bn1.running_mean', 
            'backbone_ground.layer2.2.bn1.running_var': 'backbone.layer2.2.bn1.running_var', 
            'backbone_ground.layer2.2.bn1.num_batches_tracked': 'backbone.layer2.2.bn1.num_batches_tracked', 
            'backbone_ground.layer2.2.conv2.weight': 'backbone.layer2.2.conv2.weight', 
            'backbone_ground.layer2.2.bn2.weight': 'backbone.layer2.2.bn2.weight', 
            'backbone_ground.layer2.2.bn2.bias': 'backbone.layer2.2.bn2.bias', 
            'backbone_ground.layer2.2.bn2.running_mean': 'backbone.layer2.2.bn2.running_mean', 
            'backbone_ground.layer2.2.bn2.running_var': 'backbone.layer2.2.bn2.running_var', 
            'backbone_ground.layer2.2.bn2.num_batches_tracked': 'backbone.layer2.2.bn2.num_batches_tracked', 
            'backbone_ground.layer3.0.conv1.weight': 'backbone.layer3.0.conv1.weight', 
            'backbone_ground.layer3.0.bn1.weight': 'backbone.layer3.0.bn1.weight', 
            'backbone_ground.layer3.0.bn1.bias': 'backbone.layer3.0.bn1.bias', 
            'backbone_ground.layer3.0.bn1.running_mean': 'backbone.layer3.0.bn1.running_mean', 
            'backbone_ground.layer3.0.bn1.running_var': 'backbone.layer3.0.bn1.running_var', 
            'backbone_ground.layer3.0.bn1.num_batches_tracked': 'backbone.layer3.0.bn1.num_batches_tracked', 
            'backbone_ground.layer3.0.conv2.weight': 'backbone.layer3.0.conv2.weight', 
            'backbone_ground.layer3.0.bn2.weight': 'backbone.layer3.0.bn2.weight', 
            'backbone_ground.layer3.0.bn2.bias': 'backbone.layer3.0.bn2.bias', 
            'backbone_ground.layer3.0.bn2.running_mean': 'backbone.layer3.0.bn2.running_mean', 
            'backbone_ground.layer3.0.bn2.running_var': 'backbone.layer3.0.bn2.running_var', 
            'backbone_ground.layer3.0.bn2.num_batches_tracked': 'backbone.layer3.0.bn2.num_batches_tracked', 
            'backbone_ground.layer3.0.downsample.0.weight': 'backbone.layer3.0.downsample.0.weight', 
            'backbone_ground.layer3.0.downsample.1.weight': 'backbone.layer3.0.downsample.1.weight', 
            'backbone_ground.layer3.0.downsample.1.bias': 'backbone.layer3.0.downsample.1.bias', 
            'backbone_ground.layer3.0.downsample.1.running_mean': 'backbone.layer3.0.downsample.1.running_mean', 
            'backbone_ground.layer3.0.downsample.1.running_var': 'backbone.layer3.0.downsample.1.running_var', 
            'backbone_ground.layer3.0.downsample.1.num_batches_tracked': 'backbone.layer3.0.downsample.1.num_batches_tracked', 
            'backbone_ground.layer3.1.conv1.weight': 'backbone.layer3.1.conv1.weight', 
            'backbone_ground.layer3.1.bn1.weight': 'backbone.layer3.1.bn1.weight', 
            'backbone_ground.layer3.1.bn1.bias': 'backbone.layer3.1.bn1.bias', 
            'backbone_ground.layer3.1.bn1.running_mean': 'backbone.layer3.1.bn1.running_mean', 
            'backbone_ground.layer3.1.bn1.running_var': 'backbone.layer3.1.bn1.running_var', 
            'backbone_ground.layer3.1.bn1.num_batches_tracked': 'backbone.layer3.1.bn1.num_batches_tracked', 
            'backbone_ground.layer3.1.conv2.weight': 'backbone.layer3.1.conv2.weight', 
            'backbone_ground.layer3.1.bn2.weight': 'backbone.layer3.1.bn2.weight', 
            'backbone_ground.layer3.1.bn2.bias': 'backbone.layer3.1.bn2.bias', 
            'backbone_ground.layer3.1.bn2.running_mean': 'backbone.layer3.1.bn2.running_mean', 
            'backbone_ground.layer3.1.bn2.running_var': 'backbone.layer3.1.bn2.running_var', 
            'backbone_ground.layer3.1.bn2.num_batches_tracked': 'backbone.layer3.1.bn2.num_batches_tracked', 
            'backbone_ground.layer3.2.conv1.weight': 'backbone.layer3.2.conv1.weight', 
            'backbone_ground.layer3.2.bn1.weight': 'backbone.layer3.2.bn1.weight', 
            'backbone_ground.layer3.2.bn1.bias': 'backbone.layer3.2.bn1.bias', 
            'backbone_ground.layer3.2.bn1.running_mean': 'backbone.layer3.2.bn1.running_mean', 
            'backbone_ground.layer3.2.bn1.running_var': 'backbone.layer3.2.bn1.running_var', 
            'backbone_ground.layer3.2.bn1.num_batches_tracked': 'backbone.layer3.2.bn1.num_batches_tracked', 
            'backbone_ground.layer3.2.conv2.weight': 'backbone.layer3.2.conv2.weight', 
            'backbone_ground.layer3.2.bn2.weight': 'backbone.layer3.2.bn2.weight', 
            'backbone_ground.layer3.2.bn2.bias': 'backbone.layer3.2.bn2.bias', 
            'backbone_ground.layer3.2.bn2.running_mean': 'backbone.layer3.2.bn2.running_mean', 
            'backbone_ground.layer3.2.bn2.running_var': 'backbone.layer3.2.bn2.running_var', 
            'backbone_ground.layer3.2.bn2.num_batches_tracked': 'backbone.layer3.2.bn2.num_batches_tracked', 
            'backbone_ground.layer3.3.conv1.weight': 'backbone.layer3.3.conv1.weight', 
            'backbone_ground.layer3.3.bn1.weight': 'backbone.layer3.3.bn1.weight', 
            'backbone_ground.layer3.3.bn1.bias': 'backbone.layer3.3.bn1.bias', 
            'backbone_ground.layer3.3.bn1.running_mean': 'backbone.layer3.3.bn1.running_mean', 
            'backbone_ground.layer3.3.bn1.running_var': 'backbone.layer3.3.bn1.running_var', 
            'backbone_ground.layer3.3.bn1.num_batches_tracked': 'backbone.layer3.3.bn1.num_batches_tracked', 
            'backbone_ground.layer3.3.conv2.weight': 'backbone.layer3.3.conv2.weight', 
            'backbone_ground.layer3.3.bn2.weight': 'backbone.layer3.3.bn2.weight', 
            'backbone_ground.layer3.3.bn2.bias': 'backbone.layer3.3.bn2.bias', 
            'backbone_ground.layer3.3.bn2.running_mean': 'backbone.layer3.3.bn2.running_mean', 
            'backbone_ground.layer3.3.bn2.running_var': 'backbone.layer3.3.bn2.running_var', 
            'backbone_ground.layer3.3.bn2.num_batches_tracked': 'backbone.layer3.3.bn2.num_batches_tracked', 

            'backbone_ground.layer3.4.conv1.weight': 'backbone.layer3.4.conv1.weight', 
            'backbone_ground.layer3.4.bn1.weight': 'backbone.layer3.4.bn1.weight', 
            'backbone_ground.layer3.4.bn1.bias': 'backbone.layer3.4.bn1.bias', 
            'backbone_ground.layer3.4.bn1.running_mean': 'backbone.layer3.4.bn1.running_mean', 
            'backbone_ground.layer3.4.bn1.running_var': 'backbone.layer3.4.bn1.running_var', 
            'backbone_ground.layer3.4.bn1.num_batches_tracked': 'backbone.layer3.4.bn1.num_batches_tracked', 
            'backbone_ground.layer3.4.conv2.weight': 'backbone.layer3.4.conv2.weight', 
            'backbone_ground.layer3.4.bn2.weight': 'backbone.layer3.4.bn2.weight', 
            'backbone_ground.layer3.4.bn2.bias': 'backbone.layer3.4.bn2.bias', 
            'backbone_ground.layer3.4.bn2.running_mean': 'backbone.layer3.4.bn2.running_mean', 
            'backbone_ground.layer3.4.bn2.running_var': 'backbone.layer3.4.bn2.running_var', 
            'backbone_ground.layer3.4.bn2.num_batches_tracked': 'backbone.layer3.4.bn2.num_batches_tracked', 

            'backbone_ground.layer3.5.conv1.weight': 'backbone.layer3.5.conv1.weight', 
            'backbone_ground.layer3.5.bn1.weight': 'backbone.layer3.5.bn1.weight', 
            'backbone_ground.layer3.5.bn1.bias': 'backbone.layer3.5.bn1.bias', 
            'backbone_ground.layer3.5.bn1.running_mean': 'backbone.layer3.5.bn1.running_mean', 
            'backbone_ground.layer3.5.bn1.running_var': 'backbone.layer3.5.bn1.running_var', 
            'backbone_ground.layer3.5.bn1.num_batches_tracked': 'backbone.layer3.5.bn1.num_batches_tracked', 
            'backbone_ground.layer3.5.conv2.weight': 'backbone.layer3.5.conv2.weight', 
            'backbone_ground.layer3.5.bn2.weight': 'backbone.layer3.5.bn2.weight', 
            'backbone_ground.layer3.5.bn2.bias': 'backbone.layer3.5.bn2.bias', 
            'backbone_ground.layer3.5.bn2.running_mean': 'backbone.layer3.5.bn2.running_mean', 
            'backbone_ground.layer3.5.bn2.running_var': 'backbone.layer3.5.bn2.running_var', 
            'backbone_ground.layer3.5.bn2.num_batches_tracked': 'backbone.layer3.5.bn2.num_batches_tracked', 
    ...
    def inference(self, images, target1, targets=None, query_img_as_gallery=False):
        """
        images: 测试图像列表（batch size=1，包含空中或地面视角的单张图片）
        targets: 目标列表（包含 img_name 等信息）
        query_img_as_gallery: Set to True to detect all people in the query image.
            Meanwhile, the gt box should be the first of the detected boxes.
            This option serves CBGM.
        Returns:
            detections: 检测结果（gallery 模式）或嵌入特征（query 模式）
            timing_info: 字典，包含检测和特征提取的耗时（毫秒）和 FPS
        """
        original_image_sizes = []
        original_image_sizes.extend([img.shape[-2:] for img in images])
        # Transform images and targets
        images, targets = self.transform(images, targets)  # ImageList object

        # 获取 batch size
        batchsize = images.tensors.shape[0]
        assert batchsize == 1, "Inference batch size should be 1"
        batchsize_air = 0
        batchsize_ground = 0

        # 根据 target1 的 img_name 判断视角
        air_indices = []
        ground_indices = []
        for idx in range(batchsize):
            if target1[idx]["img_name"].startswith("D"):  # 空中视角
                batchsize_air += 1
                air_indices.append(idx)
            else:  # 地面视角
                batchsize_ground += 1
                ground_indices.append(idx)

        # 分别提取出 images_aerial 和 images_ground 的张量
        images_aerial_tensors = images.tensors[air_indices] if air_indices else torch.empty(0, *images.tensors.shape[1:], device=images.tensors.device)
        images_ground_tensors = images.tensors[ground_indices] if ground_indices else torch.empty(0, *images.tensors.shape[1:], device=images.tensors.device)

        # 重新构造 ImageList 对象
        images_aerial = ImageList(images_aerial_tensors, [images.image_sizes[i] for i in air_indices]) if air_indices else None
        images_ground = ImageList(images_ground_tensors, [images.image_sizes[i] for i in ground_indices]) if ground_indices else None

        # 分别提取出 targets_aerial 和 targets_ground
        if targets is not None:
            targets_aerial = [targets[i] for i in air_indices] if air_indices else None
            targets_ground = [targets[i] for i in ground_indices] if ground_indices else None
        else:
            targets_aerial = None
            targets_ground = None

        # 提取特征并计时
        if batchsize_air == 1:  # 空中视角   
            features = self.backbone_aerial(images_aerial.tensors)   
            features_aerial = OrderedDict([("feat_res4", features["feat_res4"])])
            features_ground = None
        elif batchsize_ground == 1:  # 地面视角  
            features = self.backbone_ground(images_ground.tensors)
            features_aerial = None
            features_ground = OrderedDict([("feat_res4", features["feat_res4"])])
        else:
            raise ValueError("Batch size is 1, but neither air nor ground perspective detected.")

        # 处理 Query 或 Gallery 模式
        if targets is not None and not query_img_as_gallery:  # Query 模式
            boxes = [t["boxes"] for t in targets]
            box_features = self.roi_heads.box_roi_pool(features, boxes, images.image_sizes)
            box_features = self.roi_heads.reid_head(box_features)
            embeddings, _ = self.roi_heads.embedding_head(box_features)
    ...
    def forward(self, images, target1, targets=None, query_img_as_gallery=False):
        # 如果模型不是处于训练状态，则调用inference方法执行前向传播，并生成检测结果或嵌入特征
        if not self.training:
            return self.inference(images, target1, targets, query_img_as_gallery)
        ...
        # 根据 targets 的 img_name 判断空中和地面视角的图像数量，并记录索引
        air_indices = []
        ground_indices = []
        for idx in range(batchsize):
            if targets[idx]["img_name"].startswith("D"):
                batchsize_air += 1
                air_indices.append(idx)
            else:
                batchsize_ground += 1
        ...
        # 重新构造 ImageList 对象
        images_aerial = ImageList(images_aerial_tensors, [images.image_sizes[i] for i in air_indices])
        images_ground = ImageList(images_ground_tensors, [images.image_sizes[i] for i in ground_indices])
        
        # 分别提取出 targets_aerial 和 targets_ground
        if targets is not None:
            targets_aerial = [targets[i] for i in air_indices] if air_indices else []
            targets_ground = [targets[i] for i in ground_indices] if ground_indices else []
        else:
            targets_aerial = None
            targets_ground = None
        ...
        # 合并空中和地面视角的 RPN 损失
        combined_rpn_losses = {}
        if proposal_losses_aerial and proposal_losses_ground:
        ...
        elif proposal_losses_aerial:
            for key in proposal_losses_aerial.keys():
                combined_rpn_losses[key] = 0.5 * proposal_losses_aerial[key]
        elif proposal_losses_ground:
            for key in proposal_losses_ground.keys():
                combined_rpn_losses[key] = 0.5 * proposal_losses_ground[key]
...
class SeqRoIHeads(RoIHeads):
    def __init__(
        ...
        **kwargs
        ...
        # Re-ID head 共享
        self.embedding_head = NormAwareEmbedding()
        self.reid_loss = OIMLoss(256, num_pids, num_cq_size, oim_momentum, oim_scalar)   #有实验reid输出改为512维度
    ...
    def forward(self, features, image_shapes, features_air=None, features_ground=None, proposals_air=None, proposals_ground=None, targets_aerial=None, targets_ground=None, query_img_as_gallery=False):
        ...
        if self.training:
            ...
            if proposal_regs_air is not None and proposal_regs_ground is not None:
                box_labels = box_labels_air + box_labels_ground
                box_reg_targets = box_reg_targets_air + box_reg_targets_ground
            elif proposal_regs_air is not None:
                box_labels = box_labels_air
                box_reg_targets = box_reg_targets_air
            else:
                box_labels = box_labels_ground
                box_reg_targets = box_reg_targets_ground
...
class NormAwareEmbedding(nn.Module):
    ...
    def __init__(self, featmap_names=["feat_res4", "feat_res5"], in_channels=[256, 512], dim=256):    #有实验Re-id输出改为512维度
