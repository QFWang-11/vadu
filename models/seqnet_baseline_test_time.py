...
from models.resnet_for_seqnet import build_resnet
import time

class SeqNet_0(nn.Module):
    def __init__(self, cfg):
        super(SeqNet_0, self).__init__()
    ...
    def inference(self, images, targets=None, query_img_as_gallery=False):
        ...
        if targets is not None and not query_img_as_gallery:
            ...
            timing_info["total_time"] = ( 
                ...
                timing_info["faster_rcnn_time"] +
                timing_info["baseline_head_time"] +
                timing_info["postprocess_proposals_time"] +
...
class SeqRoIHeads(RoIHeads):
    ...
    def forward(self, features, proposals, image_shapes, targets=None, query_img_as_gallery=False):
        ...
        # Initialize timing dictionary for ROI heads
        timing_info = {
            "postprocess_proposals_time": 0.0,
            "faster_rcnn_time": 0.0,
        ...
        timing_info["faster_rcnn_time"] = (time.time() - time_start) * 1000
        ...
        if self.training:
            ...
            timing_info["postprocess_proposals_time"] = (time.time() - time_start) * 1000
        ...
        if boxes[0].shape[0] == 0:
            ...
            return [dict(boxes=boxes, labels=labels, scores=scores, embeddings=embeddings)], [], timing_info
