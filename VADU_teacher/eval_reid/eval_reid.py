...
def testwithVer2(config, loaders, gallery_features, query_features):
    ...
    if gallery_path is not None:
        ...
        detect_root = r'/home/patrick/wqf/Data/G2APS/G2APS_in_market1501_style/Market-1501-v15.09.15/'
        ids_dir = os.path.join(detect_root, 'bounding_box_test_ids')

    print('Now detector root is: ', detect_root)

    testmat = r'/home/patrick/wqf/Data/G2APS/G2APS/annotation/test/train_test/TestG50.mat'
